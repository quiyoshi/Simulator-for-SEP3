...
public class InstructionSet extends Factory<Integer, Operation> {
	...
	public static final int OP_INC  = 0x100;	// 以下は、命令とは直接関係がなく、
	public static final int OP_DEC  = 0x101;	// 内部でだけ使う動作
	public static final int OP_THRA = 0x102;	// Aバスのデータを素通し
	public static final int OP_THRB = 0x103;	// Bバスのデータを素通し
	public static final int OP_ADD2 = 0x104;	// ADDと同じだが、PSW更新せず
	public static final int OP_SUB2 = 0x105;	// SUBと同じだが、PSW更新せず
	...
	public InstructionSet(CPU cpu) {
		...
		makeItem(new Integer(OP_SUB2), new Sub2Operation(cpu));
	...
	public boolean isLegalInstruction(int opcode) {
		Operation v;
		switch (opcode) {
		case OP_INC: case OP_DEC: case OP_THRA: case OP_THRB: case OP_ILL:
			v = null;
			break;
		default:
